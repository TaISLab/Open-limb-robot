%% Static Grasp Retention Test Without Wheel Motion
% The DYNAMIXEL establishes and maintains the grip on the cylinder,
% while the DC wheels remain stationary throughout the experiment.
...
% =========================================================
MU_ESTIMADO         =0.4;     % CAMBIAR ESTE VALOR PARA CADA PRUEBA (0.2, 0.35, 0.5, 1.0)
...
% Set to zero because this test evaluates static grasp retention only; no wheel motion is commanded
TARGET_PULSES = 0;  
% Allows continuous rotation STOP_ANGLE          = 360
STOP_ANGLE          = 360;     % Allows continuous rotation
